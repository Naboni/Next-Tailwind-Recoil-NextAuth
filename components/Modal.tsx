...
function Modal() {
  ...
  const uploadPost = async () => {
    ...
    // 4) get  download URL from fb storage and update the original post with image
      ...
      >
        <div className="flex min-h-[800px] items-end justify-center px-4 pt-4 pb-20 text-center sm:block sm:min-h-screen sm:p-0">
          ...
          <Transition.Child
            ...
            leaveTo="opacity-0 translate-y-4 smL"
          >
            <div
              className="inline-block transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4
                text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:align-middle
            "
            >
              <div>
                {selectedFile ? (
                ...
                <div className="mt-5 sm:mt-6">
                  <button
                    ...
                    focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:cursor-not-allowed
